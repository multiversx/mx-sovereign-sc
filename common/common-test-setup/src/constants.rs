...
pub const SOV_ID_1: TestTokenIdentifier = TestTokenIdentifier::new("sov-USDC-c76f1f");
pub const SOV_ID_2: TestTokenIdentifier = TestTokenIdentifier::new("sov-GREEN-0e161c");
