...
pub const SOV_FIRST_TEST_TOKEN: TestTokenIdentifier = TestTokenIdentifier::new("sov-GREEN-ab3df1");
pub const SOV_SECOND_TEST_TOKEN: TestTokenIdentifier = TestTokenIdentifier::new("sov-LTST-1d3abc");
