...
pub const SOV_FIRST_TOKEN_ID: TestTokenIdentifier = TestTokenIdentifier::new("sov-ABC-ab3df1");
pub const SOV_SECOND_TOKEN_ID: TestTokenIdentifier = TestTokenIdentifier::new("sov-XYZ-1d3abc");
pub const FIRST_TOKEN_ID: TestTokenIdentifier = TestTokenIdentifier::new("ABC-123456");
pub const SECOND_TOKEN_ID: TestTokenIdentifier = TestTokenIdentifier::new("XYZ-678901");
...
pub const TRANSFER_VALUE_ONLY_LOG: &str = "transferValueOnly";
