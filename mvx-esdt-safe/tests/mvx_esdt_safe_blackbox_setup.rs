...
use multiversx_sc::{
    ...
    types::{
        EsdtLocalRole, ManagedAddress, ManagedBuffer, ManagedVec, TestSCAddress,
...
impl MvxEsdtSafeTestState {
    ...
    pub fn deploy_and_complete_setup_phase(&mut self, fee: Option<FeeStruct<StaticApi>>) {
        self.deploy_contract_with_roles(fee);
        self.common_setup
