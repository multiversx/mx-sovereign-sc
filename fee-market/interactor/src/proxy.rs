...
impl<Api> Default for FeeStruct<Api>
where
    Api: ManagedTypeApi,
    TokenIdentifier<Api>: Default,   // Asigură-te că TokenIdentifier implementează Default
    FeeType<Api>: Default,           // Asigură-te că FeeType implementează Default
{
    fn default() -> Self {
        FeeStruct {
            base_token: TokenIdentifier::default(), // Valoare implicită pentru TokenIdentifier
            fee_type: FeeType::default(),           // Valoare implicită pentru FeeType
        }
    }
}
#[rustfmt::skip]
