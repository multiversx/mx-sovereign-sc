use common_test_setup::constants::{
    FEE_TOKEN, FIRST_TEST_TOKEN, OPERATION_HASH_STATUS_STORAGE_KEY, SECOND_TEST_TOKEN,
};
use error_messages::{
    BANNED_ENDPOINT_NAME, GAS_LIMIT_TOO_HIGH, NOTHING_TO_TRANSFER, NO_ESDT_SAFE_ADDRESS,
